...
value = row.children[0].children[3].children[0].textContent = "Todo Listesi Başlığı Değişmedi";
...
let todo2 = contain.children[0].children[0].children[1].children[0].children[1]; todo2.textContent = "Todo ekleyin lütfen hemen";
todo2.style.backgroundColor = "green";
